...
func GetTypeMetadataEntry(schema string, name string, oid uint32) (string, toc.MetadataEntry) {
	return "predata",
		toc.MetadataEntry{
			Schema:          schema,
			Name:            name,
...
func (t BaseType) GetMetadataEntry() (string, toc.MetadataEntry) {
	return GetTypeMetadataEntry(t.Schema, t.Name, t.Oid)
}
...
func GetBaseTypes(connectionPool *dbconn.DBConn) []BaseType {
	...
	gplog.Debug("GetBaseTypes, query is %v", query)
...
func GetCompositeTypes(connectionPool *dbconn.DBConn) []CompositeType {
	...
	gplog.Debug("GetCompositeTypes, query is %v", query)
...
func getCompositeTypeAttributes(connectionPool *dbconn.DBConn) map[uint32][]Attribute {
	...
	gplog.Debug("getCompositeTypeAttributes, query is %v", query)
...
func GetDomainTypes(connectionPool *dbconn.DBConn) []Domain {
	...
	gplog.Debug("GetDomainTypes, query is %v", query)
	err := connectionPool.Select(&results, query)
	gplog.FatalOnError(err)
	return results
}
...
func GetEnumTypes(connectionPool *dbconn.DBConn) []EnumType {
	...
	gplog.Debug("GetEnumTypes, query is %v", query)
...
func GetRangeTypes(connectionPool *dbconn.DBConn) []RangeType {
	...
	gplog.Debug("GetRangeTypes, query is %v", query)
...
func GetShellTypes(connectionPool *dbconn.DBConn) []ShellType {
	...
	gplog.Debug("GetShellTypes, query is %v", query)
...
type Collation struct {
	...
	Collate string
	Ctype   string
	// https://github.com/greenplum-db/gpbackup/commit/1651d7477ceed4fb45ece33fcd481ba4d7852f06
	Provider        string
...
func GetCollations(connectionPool *dbconn.DBConn) []Collation {
	...
	gplog.Debug("GetCollations, query is %v", query)
