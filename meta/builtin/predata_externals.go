...
type ExternalTableDefinition struct {
	...
	FormatType   string
	FormatOpts   string
	// Options         string  // https://github.com/greenplum-db/gpbackup/commit/17eb6ab5d1c9d884ac4de62f445aba59336c0203
	Command         string
	RejectLimit     int
	RejectLimitType string
	ErrTableName    string
	ErrTableSchema  string
	LogErrors       bool // https://github.com/greenplum-db/gpbackup/commit/53bcdcc04097db8f4669ca4ae78aba93992de7a5
	LogErrPersist   bool // https://github.com/greenplum-db/gpbackup/commit/11d70b1fa15aa1d95c513ab87ff51f55bec22ce6
	Encoding        string
	Writable        bool
	URIs            []string
}
...
func generateExecuteStatement(extTableDef ExternalTableDefinition) string {
	...
	// https://github.com/greenplum-db/gpbackup/commit/ba37a929ac6fbbf4803f1e7b340a82a98eeaea9c
