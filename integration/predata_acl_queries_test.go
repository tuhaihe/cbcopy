	...
	Describe("GetMetadataForObjectType", func() {
		Context("default metadata for all objects of one type", func() {
			It("returns a slice of metadata with modified privileges", func() {
				...
				fooUniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "foo", builtin.TYPE_RELATION)
				barUniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "bar", builtin.TYPE_RELATION)
				bazUniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "baz", builtin.TYPE_RELATION)
				expectedFoo := builtin.ObjectMetadata{ObjectType: "RELATION", Privileges: []builtin.ACL{testutils.DefaultACLWithout("testrole", "TABLE", "DELETE")}, Owner: "testrole"}
				expectedBar := builtin.ObjectMetadata{ObjectType: "RELATION", Privileges: []builtin.ACL{{Grantee: "GRANTEE"}}, Owner: "testrole"}
				expectedBaz := builtin.ObjectMetadata{ObjectType: "RELATION", Privileges: []builtin.ACL{testutils.DefaultACLForType("anothertestrole", "TABLE"), testutils.DefaultACLForType("testrole", "TABLE")}, Owner: "testrole"}
			...
			It("returns a slice of default metadata for a database", func() {
				...
				expectedMetadata := builtin.ObjectMetadata{
					ObjectType: "DATABASE", Privileges: []builtin.ACL{
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_DATABASE)

				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testdb", builtin.TYPE_DATABASE)
			...
			It("returns a slice of default metadata for a role", func() {
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_ROLE)
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testuser", builtin.TYPE_ROLE)
			...
			It("returns a slice of metadata with the owner in quotes", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testtable", builtin.TYPE_RELATION)
				expectedMetadata := builtin.ObjectMetadata{ObjectType: "RELATION", Privileges: []builtin.ACL{}, Owner: `"Role1"`}
			...
			It("returns a slice of default metadata for a sequence", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testsequence", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for a procedural language", func() {
				...
				var expectedMetadata builtin.ObjectMetadata
				if connectionPool.Version.Before("5") {
					langOwner := testutils.GetUserByID(connectionPool, 10)
					expectedMetadata = builtin.ObjectMetadata{ObjectType: "LANGUAGE", Privileges: []builtin.ACL{}, Owner: langOwner, Comment: "This is a language comment."}
				} else {
					expectedMetadata = testutils.DefaultMetadata("LANGUAGE", false, true, true, includeSecurityLabels)
				}
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", plpythonString, builtin.TYPE_PROCLANGUAGE)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
			*/
...
LANGUAGE SQL`)
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "add", builtin.TYPE_FUNCTION)
				resultMetadata := resultMetadataMap[uniqueID]
				...
				expectedMetadata := builtin.ObjectMetadata{ObjectType: "FUNCTION", Privileges: []builtin.ACL{{Grantee: "GRANTEE"}}, Owner: "testrole", SecurityLabel: slabel, SecurityLabelProvider: slabelProvider}
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
...
LANGUAGE SQL`)
			...
			It("returns a slice of default metadata for a view", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testview", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for a materialized view", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testmview", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for a schema", func() {
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_SCHEMA)

				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testschema", builtin.TYPE_SCHEMA)
	...
	INITCOND = '0'
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "agg_prefunc", builtin.TYPE_AGGREGATE)
			...
			It("returns a slice of default metadata for a type", func() {
				...
				typeUniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testtype", builtin.TYPE_TYPE)
			...
			It("returns a slice of default metadata for a domain", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "domain_type", builtin.TYPE_TYPE)
			...
			It("returns a slice of default metadata for an external protocol", func() {
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_PROTOCOL)

				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "s3_read", builtin.TYPE_PROTOCOL)
			...
			It("returns a slice of default metadata for a tablespace", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "test_tablespace", builtin.TYPE_TABLESPACE)
			...
			It("returns a slice of default metadata for an operator", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "####", builtin.TYPE_OPERATOR)
			...
			*/
			It("returns a slice of default metadata for an operator family", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testfam", builtin.TYPE_OPERATORFAMILY)
			...
			It("returns a slice of default metadata for an operator class", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testclass", builtin.TYPE_OPERATORCLASS)
			...
			It("returns a slice of default metadata for a foreign data wrapper", func() {
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_FOREIGNDATAWRAPPER)

				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "foreignwrapper", builtin.TYPE_FOREIGNDATAWRAPPER)
			...
			It("returns a slice of default metadata for a foreign server", func() {
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_FOREIGNSERVER)

				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "foreignserver", builtin.TYPE_FOREIGNSERVER)
			...
			It("returns a slice of default metadata for a collation", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "some_coll", builtin.TYPE_COLLATION)
...
AS $$ BEGIN RAISE EXCEPTION 'exception'; END; $$;`)
			...
			It("returns ACL information for a newly declared TYPE_TYPE object", func() {
				...
				resultMetadataMap := builtin.GetMetadataForObjectType(connectionPool, builtin.TYPE_TYPE)
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "my_type", builtin.TYPE_TYPE)
				resultMetadata := resultMetadataMap[uniqueID]
		...
		Context("metadata for objects in a specific schema", func() {
			...
			It("returns a slice of default metadata for a table in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testtable", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for a function in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "add", builtin.TYPE_FUNCTION)
			...
			It("returns a slice of default metadata for a view in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testview", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for a materialized view in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testmview", builtin.TYPE_RELATION)
			...
			It("returns a slice of default metadata for an aggregate in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "agg_prefunc", builtin.TYPE_AGGREGATE)
			...
			It("returns a slice of default metadata for a type in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testtype", builtin.TYPE_TYPE)
			...
			It("returns a slice of default metadata for an operator in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "####", builtin.TYPE_OPERATOR)
				expectedMetadata := testutils.DefaultMetadata("OPERATOR", false, true, true, false)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
			*/
			It("returns a slice of default metadata for an operator family in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testfam", builtin.TYPE_OPERATORFAMILY)
				expectedMetadata := testutils.DefaultMetadata("OPERATOR FAMILY", false, true, true, false)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
			It("returns a slice of default metadata for an operator class in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testclass", builtin.TYPE_OPERATORCLASS)
				expectedMetadata := testutils.DefaultMetadata("OPERATOR CLASS", false, true, true, false)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
			It("returns a slice of default metadata for a text search dictionary in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testdictionary", builtin.TYPE_TSDICTIONARY)
				dictionaryMetadata := testutils.DefaultMetadata("TEXT SEARCH DICTIONARY", false, true, true, false)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatch(&dictionaryMetadata, &resultMetadata)
			})
			It("returns a slice of default metadata for a text search configuration in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testconfiguration", builtin.TYPE_TSCONFIGURATION)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatch(&configurationMetadata, &resultMetadata)
			})
			It("returns a slice of default metadata for a collation in a specific schema", func() {
				...
				Expect(resultMetadataMap).To(HaveLen(1))
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "some_coll", builtin.TYPE_COLLATION)
				collationMetadata := testutils.DefaultMetadata("COLLATION", false, true, true, false)
				resultMetadata := resultMetadataMap[uniqueID]
				structmatcher.ExpectStructsToMatch(&collationMetadata, &resultMetadata)
			})
	...
	Describe("GetDefaultPrivileges", func() {
		...
		It("returns default privileges with single privilege", func() {
			...
			resultDefaultPrivileges := builtin.GetDefaultPrivileges(connectionPool)

			privs := []builtin.ACL{{Grantee: "testrole", Update: true, Select: true}}
			expectedDefaultPrivileges := builtin.DefaultPrivileges{Schema: "", Privileges: privs, ObjectType: "S", Owner: "testrole"}
		...
		It("returns default privileges with multiple privileges", func() {
			...
			expectedDefaultPrivileges := builtin.DefaultPrivileges{Schema: "", Privileges: privs, ObjectType: "r", Owner: "testrole"}
			Expect(resultDefaultPrivileges).To(HaveLen(1))
			structmatcher.ExpectStructsToMatchExcluding(&expectedDefaultPrivileges, &resultDefaultPrivileges[0], "Oid")
		})
		It("returns default privileges for role", func() {
			...
			privs := []builtin.ACL{{Grantee: "anothertestrole", Select: true, Update: true, Usage: true}, {Grantee: "testrole", Usage: true}}
			expectedDefaultPrivileges := builtin.DefaultPrivileges{Schema: "", Privileges: privs, ObjectType: "S", Owner: "anothertestrole"}
			Expect(resultDefaultPrivileges).To(HaveLen(1))
			structmatcher.ExpectStructsToMatchExcluding(&expectedDefaultPrivileges, &resultDefaultPrivileges[0], "Oid")
		})
		It("returns default privileges in schema", func() {
			...
			privs := []builtin.ACL{{Grantee: "testrole", Usage: true}}
			expectedDefaultPrivileges := builtin.DefaultPrivileges{Schema: "public", Privileges: privs, ObjectType: "S", Owner: "testrole"}
			Expect(resultDefaultPrivileges).To(HaveLen(1))
			structmatcher.ExpectStructsToMatchExcluding(&expectedDefaultPrivileges, &resultDefaultPrivileges[0], "Oid")
		})
	...
	Describe("GetCommentsForObjectType", func() {
		Context("comments for all objects of one type", func() {
			It("returns a slice of default metadata for an index", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testindex", builtin.TYPE_INDEX)
			...
			It("returns a slice of default metadata for a rule", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "update_notify", builtin.TYPE_RULE)
			...
			It("returns a slice of default metadata for a trigger", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "sync_testtable", builtin.TYPE_TRIGGER)
			...
			It("returns a slice of default metadata for a cast in 4.3", func() {
				...
				boolOid := testutils.OidFromObjectName(connectionPool, "", "bool", builtin.TYPE_TYPE)
				textOid := testutils.OidFromObjectName(connectionPool, "", "text", builtin.TYPE_TYPE)
				...
				resultMetadata := resultMetadataMap[builtin.UniqueID{ClassID: builtin.PG_CAST_OID, Oid: oid}]
				structmatcher.ExpectStructsToMatchExcluding(&expectedMetadata, &resultMetadata, "Oid")
			})
			It("returns a slice of default metadata for a cast in 5", func() {
				...
				textOid := testutils.OidFromObjectName(connectionPool, "", "text", builtin.TYPE_TYPE)
				intOid := testutils.OidFromObjectName(connectionPool, "", "int4", builtin.TYPE_TYPE)
			...
			It("returns a slice of default metadata for a resource queue", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "res_queue", builtin.TYPE_RESOURCEQUEUE)
			...
			It("returns a slice of default metadata for a text search parser", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "public", "testparser", builtin.TYPE_TSPARSER)
		...
		Context("comments for objects in a specific schema", func() {
			...
			It("returns a slice of default metadata for an index in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "", "testindex1", builtin.TYPE_INDEX)
				expectedMetadata := testutils.DefaultMetadata("INDEX", false, false, true, false)
			...
			It("returns a slice of default metadata for a constraint in a specific schema", func() {
				...
				uniqueID := testutils.UniqueIDFromObjectName(connectionPool, "testschema", "testtable_i_key", builtin.TYPE_CONSTRAINT)
